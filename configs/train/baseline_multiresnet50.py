...
from models.resnet import HPAMultiResNet50
...
model = HPAMultiResNet50(num_classes=HPADataset.num_tags)

# Restore from a checkpoint
run_uuid = "a1f4e9bd57a04f518f4b24f55c5d2aee"
weights_filename = "model_HPAMultiResNet50_16_val_loss=0.08663985.pth"
...
lr_scheduler = MultiStepLR(optimizer, milestones=[10, 20, 30, 40], gamma=0.5)
